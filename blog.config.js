...
const BLOG = {
    ...
    POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email', // 分享的服務，按顺序显示,逗号隔开,facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin
