...
const BLOG = {
    ...
    NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '4710d2cfbfb14a6c9dc7965377bb9e88',
    ...
    GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个大学生, Hi，我是一个大学牲,Hi，我是一个干饭人,欢迎来到我的博客🎉',

    CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

    AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LittleAO', // 您的昵称 例如 tangly1024
    BIO: process.env.NEXT_PUBLIC_BIO || '还在学习🥱', // 作者简介
    LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.littleao.top', // 网站地址
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '学习, 博客', // 网站关键词 英文逗号隔开

    // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'limingyang1179@163.com', // 邮箱地址 例如mail@tangly1024.com
    CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
    CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
    CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/LittleAO1179', // 你的github个人主页 例如 https://github.com/tangly1024
    ...
    COMMENT_VALINE_PLACEHOLDER: process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '欢迎您给文章提出问题或意见', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
